...
export function BlackHoleCanvas() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Smooth scroll interpolation tuned to keep the shorter hero stage responsive.
      const damping = targetProgress < scrollRatioCurrent ? 0.34 : 0.2
      ...
      let entranceScale = activeScale
        ? Math.min(1.0, Math.max(0.32, timeTracker / 1.08))
        : 0.0
